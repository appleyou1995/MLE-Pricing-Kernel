...
Path_Output = fullfile(Path_MainFolder, 'Code', '06  Output');
...
Path_Code_06 = fullfile(Path_MainFolder, 'Code', '06  MLE - Cubic B-Spline without exponential');
addpath(Path_Code_06);
