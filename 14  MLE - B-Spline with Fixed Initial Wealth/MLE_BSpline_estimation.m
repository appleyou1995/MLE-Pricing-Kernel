...
function [theta_hat, log_lik, BIC, delta_vec, M_vec, pit_vec] = MLE_BSpline_estimation( ...
    ...
    initial_wealth, b, use_delta, alpha, beta, Global_Min_R, Global_Max_R)
    ...
    n_degree = 5;
    k_order  = n_degree + 1;
    min_knot = Global_Min_R * initial_wealth;
    max_knot = Global_Max_R * initial_wealth;
